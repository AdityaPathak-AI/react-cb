...
function StudentData() {
  ...
  return (
    <div className="container bg-danger">
      <h1 style={{ textAlign: "center" }}>Enter Student Data</h1>
      ...
      <form onSubmit={addStudent}>
        <input
          ...
          onFocus={() => ({ checkstatus: false })}
        />
        &nbsp;&nbsp;
        <input type="text" placeholder="Enter Name no" ref={name} />
        &nbsp;&nbsp;
        <select ref={cls}>
          <option value="cls" required>
            Select Class
          </option>
                ...
                <tr>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => editStudentData(data.roll)}
                    >
                      Edit
                    </button>
                    &nbsp;&nbsp;||&nbsp;&nbsp;
                    <button
                      ...
                      onClick={() => deleteStudentData(index)}
                    >
                      Delete
                    </button>
                  </td>
      ...
      <div className="container">
        ...
        <form onSubmit={UpdateStudent} style={{ background: "powderblue" }}>
          <input type="number" placeholder="Enter Roll no" ref={rol} disabled />
          &nbsp;&nbsp;
