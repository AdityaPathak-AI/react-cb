...
class EmployeeData extends React.Component {
  ...
  EditData = (event) => {
    ...
    var obj = {
      id: this.uid.value,
      nameBox: this.uname.value,
      salaryBox: this.usalary.value,
      deptBox: this.udept.value,
    };
      ...
      <>
        <div className="container">
          ...
          <form onSubmit={this.addData}>
            <input
              ...
              ref={(data) => (this.id = data)}
            />
            &nbsp;&nbsp;
            <input
              type="text"
              placeholder="Enter your name"
              ref={(data) => (this.nameBox = data)}
            />
            &nbsp;&nbsp;
            <input
              type="Number"
              placeholder="Enter your Salary"
              ref={(data) => (this.salaryBox = data)}
            />
            &nbsp;&nbsp;
            <input
              type="text"
              placeholder="Enter Department"
              ref={(data) => (this.deptBox = data)}
            />
            <br />
            <br />
        ...
        <div className="container">
          ...
          <form onSubmit={this.EditData}>
            <input
              type="text"
              value={this.state.update.id}
              placeholder="Enter your id"
              ref={(data) => (this.uid = data)}
            />
            &nbsp;&nbsp;
            <input
              type="text"
              defaultValue={this.state.update.nameBox}
              placeholder="Enter your name"
              ref={(data) => (this.uname = data)}
            />
            &nbsp;&nbsp;
            <input
              type="Number"
              defaultValue={this.state.update.salaryBox}
              placeholder="Enter your Salary"
              ref={(data) => (this.usalary = data)}
            />
            &nbsp;&nbsp;
            <input
              type="text"
              defaultValue={this.state.update.deptBox}
              placeholder="Enter Department"
              ref={(data) => (this.udept = data)}
            />
            <br />
            <br />
            <button className="btn btn-danger " type="submit">
